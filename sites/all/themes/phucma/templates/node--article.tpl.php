...
<div class="col-md-6 col-xs-12 product node-detail post-<?php print $node->nid ?>">
  ...
  <div class="post">
    <div class="news">
      ...
      <span class="share-link-button" data="<?php print $node->nid ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'artline') ?>/images/ic.png"
                                                                           class="icon-link"></span>
      <div class="share-link hidden" id="share-link-<?php print $node->nid ?>"><?php print url('node/'.$node->nid,array('absolute'=>true)) ?></div>
    </div>
    ...
    <div class="more">
      ...
      <span id="comment-box-<?php print $node->nid ?>" class="comment" data="<?php print $node->nid ?>"><svg viewBox="1 0 22 22" height="100%" width="100%"><path
      ...
      <a class="store-<?php print $node->nid ?> ctools-use-modal" href="<?php print url('artline/store/'.$node->nid.'/nojs') ?>" style="display: none;">Mua hàng</a>
    </div>
    <div class="share-item" id="share-button-<?php print $node->nid ?>"><?php print render($content['links']); ?></div>
